'use client'
import ButtonCopy from '@/components/home/ButtonCopy';
import Image from 'next/image';
const SmartContract = () => {
    const smartContract = '0xa61326207C5EdE4804d8C6E1D2a1505c44eF1386';
    return (
        <div className='contract-address'>
            ...
            <div className='dex-icon'>
                <a href='https://dexscreener.com/base/0x3f8b30cf8d7f1510dda1bf53a26cd99452ebf386' target='_blank' rel='noreferrer'>
                    ...
                    <span className='name-dex'>Dexscreener</span>
                </a>
                <a href='https://www.saucerswap.finance/swap/HBAR/0.0.7926366' target='_blank' rel='noreferrer'>
                    <Image src='/images/saucerswap.png' alt='SaucerSwap' width={100} height={100} />
                    <span className='name-dex'>SaucerSwap</span>
                </a>
            </div>
            <div className='container'>
                <input type='text' value={smartContract} readOnly />
                <ButtonCopy text={smartContract} />
            </div>
        </div>
    );
};
